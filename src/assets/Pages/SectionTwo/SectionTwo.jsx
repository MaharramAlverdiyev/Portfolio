...
export const SectionTwo = () => {
    ...
    return (
        <div className='sec-two'>
            <div className="sec-two-column">
                <h1 style={{ textAlign: 'center' }}>About me</h1>
                <div className="about" id="about">
                    <div className="about-container">
                        <div className="about-me">
                            <h2 style={{ fontSize: '30px' }}>Junior Strong Front-end Developer in Baku <IoLocation style={{ color: 'red' }} /></h2>
                        ...
                        {/* <div className="about-down">
                            <div className="about-down-left">
                                <h3>Education</h3>
                                <h4></h4>
                            </div>
                            <div className="about-down-right">
                                <h3>Experience</h3>
                            </div>
                        </div> */}
                    </div>
